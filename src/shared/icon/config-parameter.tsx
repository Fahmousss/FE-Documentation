...
interface IconConfigParameter extends IconProps {}

const IconConfigParameter = forwardRef<SVGSVGElement, IconConfigParameter>(
...
export default IconConfigParameter;
